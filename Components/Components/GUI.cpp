...
void DefaultImGuiStyle()
{
    ...
    style.Colors[ImGuiCol_BorderShadow] = ImVec4(0.2f, 0.2f, 0.2f, 1.0f);
    ...
    style.Colors[ImGuiCol_Separator] = ImVec4(0.4f, 0.4f, 0.4f, 1.0f);
    style.Colors[ImGuiCol_SeparatorHovered] = ImVec4(0.5f, 0.5f, 0.5f, 1.0f);
    ...
    style.Colors[ImGuiCol_TabActive] = ImVec4(0.5f, 0.5f, 0.5f, 1.0f);
    style.Colors[ImGuiCol_TabUnfocused] = ImVec4(0.15f, 0.15f, 0.15f, 1.0f);
    style.Colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.5f, 0.5f, 0.5f, 1.0f);
    style.Colors[ImGuiCol_PlotLines] = ImVec4(0.5f, 0.5f, 0.5f, 1.0f);
    style.Colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.7f, 0.7f, 0.7f, 1.0f);
    style.Colors[ImGuiCol_PlotHistogram] = ImVec4(0.5f, 0.5f, 0.5f, 1.0f);
    style.Colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.7f, 0.7f, 0.7f, 1.0f);
    style.Colors[ImGuiCol_TextSelectedBg] = ImVec4(0.5f, 0.5f, 0.5f, 1.0f);
    style.Colors[ImGuiCol_DragDropTarget] = ImVec4(0.2f, 0.2f, 0.2f, 1.0f);
    style.Colors[ImGuiCol_NavHighlight] = ImVec4(0.2f, 0.2f, 0.2f, 1.0f);
    style.Colors[ImGuiCol_NavWindowingHighlight] = ImVec4(0.2f, 0.2f, 0.2f, 1.0f);
...
void GUIComponent::InitMainTab() {
	...
	if (ImGui::Button("Notification")) {
		Main.Execute([]() {
			Main.SpawnNotification("[Nem]", "SDK is hooked!", 10);
		});
	}*/

    if (ImGui::Button("Party inv")) { Events.shouldinvitehomie = true; Console.Write("Sending inv..."); }
    ImGui::SameLine();
    ImGui::InputText("ID", (char*)Events.trollingsteamid.c_str(), sizeof(std::string));
...
void GUIComponent::Render()
{
	...
	ImGui::SetNextWindowSize(ImVec2(510, 575));

	if (IsOpen) {
		ImGui::Begin("Made by Nem", &IsOpen, ImGuiWindowFlags_AlwaysAutoResize);
		{
